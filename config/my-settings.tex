...
% ========================
% Pseudocode Listing Setup
% ========================
\usepackage{listings} % Ensure the listings package is included

\newcounter{listingcounter} % Initialize the listing counter

\newcommand{\codelistentry}[2]{%
    \par\noindent\textit{#2} (\texttt{\ref{#1}})%
    \par
}
...
\newcommand{\listoflistings}{%
    \lstlistoflistings % Automatically generates the list of all listings
}
